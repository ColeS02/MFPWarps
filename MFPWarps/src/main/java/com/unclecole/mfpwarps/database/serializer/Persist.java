...
public class Persist {
    ...
    public File getFile(String name) {
        return new File(MFPWarps.getInstance().getDataFolder(), name + ".json");
    }
    ...
    public <T> T loadOrSaveDefault(T def, Class<T> clazz, File file) {
        if (!file.exists()) {
            MFPWarps.getInstance().getLogger().info("Creating default: " + file);
            this.save(def, file);
            return def;
        }
        ...
        if (loaded == null) {
            MFPWarps.getInstance().getLogger().warning("Using default as I failed to load: " + file);
            ...
            MFPWarps.getInstance().getLogger().warning("Backing up copy of bad file to: " + backup);
    ...
    public <T> T load(Class<T> clazz, File file) {
        ...
        try {
            ...
            MFPWarps.getInstance().getLogger().warning(ex.getMessage());
        }
